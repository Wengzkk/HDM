...
def test_epoch(model: HDMModel, dataloader: DataLoader, device: str, is_vis, img_dir, class_name, cal_pro):
    ...
    if is_vis:
        plot_sample_cv2(names, test_imgs, {'HDM': scores}, gt_mask_list, save_folder=img_dir)
        plot_anomaly_score_distributions({'HDM': scores}, gt_mask_list, save_folder=img_dir,
